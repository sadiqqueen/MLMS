    ...
    <>
      ...
      <main className="admin-main">
        ...
        <div className="admin-card">
          {!isAdmin && (
            <div className="admin-tabs" style={{ display: 'flex', gap: 6, padding: '12px 20px' }}>
              <Sk w={100} h={32} r={6} />
              <Sk w={110} h={32} r={6} />
            </div>
          )}
          ...
          <div className="admin-table-wrap">
            <table className="admin-table">
              <thead>
                <tr>
                  {['#', 'Name', 'City', 'Address', 'Assigned Doctor', 'Specialties', 'Actions'].map(c => <th key={c}>{c}</th>)}
                </tr>
              </thead>
              <tbody>
                {[...Array(8)].map((_, i) => (
                  <tr key={i}>
                    ...
                    <td><Sk w={140} h={13} /></td>
                    <td><Sk w={110} h={13} /></td>
                    <td><div style={{ display: 'flex', gap: 4 }}><Sk w={60} h={20} r={20} /><Sk w={70} h={20} r={20} /></div></td>
