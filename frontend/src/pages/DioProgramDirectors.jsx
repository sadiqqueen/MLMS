                    ...
                    <tr key={p._id} style={{ opacity: active ? 1 : 0.65 }}>
                      ...
                      <td>
                        <div style={{ display:'flex', gap:5 }}>
                          <button className="btn-action edit" onClick={() => { setEditItem(p); setShowModal(true); }}>Edit</button>
                          {active
                            ? <button className="btn-action delete" onClick={() => setConfirmDeact(p)}>Deactivate</button>
                            : <button style={{ padding:'5px 10px', borderRadius:6, background:'#D1FAE5', color:'#065F46', border:'none', fontSize:11, fontWeight:600, cursor:'pointer' }}
                                onClick={() => setConfirmReact(p)}>Reactivate</button>
                          }
                        </div>
                      </td>
                    </tr>
