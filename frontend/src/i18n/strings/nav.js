...
const nav = {
  ar: {
    ...
    // head_ad — the clerk's six pages (read-only) + a Permissions inbox.
    'nav.head_ad.dashboard':             'لوحة التحكم',
    'nav.head_ad.countries':             'الدول',
    'nav.head_ad.centers':               'المراكز التدريبية',
    'nav.head_ad.programs':              'البرامج',
  ...
  en: {
    ...
    // head_ad — the clerk's six pages (read-only) + a Permissions inbox.
    'nav.head_ad.dashboard':             'Dashboard',
    'nav.head_ad.countries':             'Countries',
    'nav.head_ad.centers':               'Training Centers',
    'nav.head_ad.programs':              'Programs',
    'nav.head_ad.dios':                  'DIOs',
    'nav.head_ad.pds':                   'PDs',
