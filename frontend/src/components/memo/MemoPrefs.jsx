...
export const STRINGS = {
  ar: {
    ...
    // approval (اعتماد) + approved memos
    approve: 'اعتماد', approvedMemos: 'المذكرات المعتمدة',
    approveConfirmTitle: 'اعتماد المذكرة؟',
    approveConfirmBody: 'بعد الاعتماد تُنقل المذكرة إلى «المذكرات المعتمدة» ولا يمكن تعديلها أو حذفها نهائيًا.',
    approveYes: 'نعم، اعتمِد', approvedToast: 'تم اعتماد المذكرة', approveError: 'فشل الاعتماد، حاول مجددًا',
    chipApproved: 'معتمدة', approvedAtLabel: 'اعتُمدت', approvedByLabel: 'اعتمدها',
    emptyApproved: 'لا توجد مذكرات معتمدة بعد', view: 'عرض',
    // translation
  ...
  en: {
    ...
    approve: 'Approve', approvedMemos: 'Approved memos',
    approveConfirmTitle: 'Approve this memo?',
    approveConfirmBody: 'After approval the memo moves to "Approved memos" and can never be edited or deleted.',
    approveYes: 'Yes, approve', approvedToast: 'Memo approved', approveError: 'Approval failed, try again',
    chipApproved: 'Approved', approvedAtLabel: 'Approved', approvedByLabel: 'Approved by',
    emptyApproved: 'No approved memos yet', view: 'View',
