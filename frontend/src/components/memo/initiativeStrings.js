...
export const INIT_STRINGS = {
  ar: {
    ...
    purgeConfirmTitle: 'حذف نهائي؟',
    purgeConfirmBody: 'سيتم حذف المبادرة نهائيًا ولا يمكن التراجع عن هذا الإجراء.',
    purgeYes: 'نعم، احذف نهائيًا',
    purgedToast: 'تم الحذف النهائي',
  ...
  en: {
    ...
    purgeConfirmBody: 'The initiative will be permanently deleted. This action cannot be undone.',
    purgeYes: 'Yes, delete permanently',
    purgedToast: 'Permanently deleted',
